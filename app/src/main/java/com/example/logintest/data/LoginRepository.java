...
public class LoginRepository {
    ...
    public LoginDataSourceResult<LoggedInUser> login(String username, String password) {
        // handle login
        LoginDataSourceResult<LoggedInUser> loginDataSourceResult = dataSource.login(username, password);
        if (loginDataSourceResult instanceof LoginDataSourceResult.Success) {
            setLoggedInUser(((LoginDataSourceResult.Success<LoggedInUser>) loginDataSourceResult).getData());
        }
